...
export type ChannelOverwriteUpdatedEvent = BaseEvent<
  'channel_overwrite.updated',
  ChannelOverwriteUpdatedData
>;
export type ChannelOverwriteDeletedEvent = BaseEvent<
  'channel_overwrite.deleted',
  ChannelOverwriteDeletedData
>;
